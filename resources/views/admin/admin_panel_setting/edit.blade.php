...
<div class="card">
   <div class="card-header">
      <h3 class="card-title card_title_center">  update system settings</h3>
   </div>
   <div class="card-body">
      ...
      <form action="{{ route('admin_panel_settings.update') }}" >
         <div class="row">
            ...
            <div class="col-md-12">
               <div class="form-group">
                  <label>Dellay minute to count</label>
            ...
            <div class="col-md-12">
               <div class="form-group">
                  <label>Minute leave away before</label>
      ...
      @else
      <p class="bg-danger text-center"> no data to display</p>
      @endif
   </div>
</div>
@endsection